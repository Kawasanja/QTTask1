    ...
    : QWidget(parent)
{
    ...
    txt1 = new QTextEdit;
    txt2 = new QTextEdit;
    ConnectClass * tmp = new ConnectClass(0,txt1,txt2);
    ...
    connect(tmp,SIGNAL(mySignal3(QString)),txt2,SLOT(setText(QString)));
    connect(tmp,SIGNAL(mySignal4(QString)),txt1,SLOT(setText(QString)));
